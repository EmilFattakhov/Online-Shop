...
class Ability
  ...
  # with 'current_user' passed to the initialize method below
  ...
  def initialize(user)
    ...
    # means the alias can be used in place for 
    # any of the supplied actions.
    # In this case, :crud can be used wherever :create,
    # :read, :update, :destroy would be used
    alias_action :create, :read, :update, :destroy, to: :crud
    # To define permission for a user, use the 'can'
    ...
    # "can? :like @quesiton" will execute the above rule 
